...
public class ProductService {
    ...
    public ResponseEntity<?> getProductDetailsService(long cardNumber) {
        ...
        if (productList.isEmpty()) {
            ...
            // Check if the total pending amount exceeds 10000 and update the defaulter column
            ...
            try (CSVWriter writer = new CSVWriter(new FileWriter(filePath))) {
                ...
                String[] headers = {"Product ID", "Product Name", "Quantity", "Unit Price", "Total Price", "Paid", "PurchasedDate"};
                writer.writeNext(headers);

                // Writing product data to CSV file
                for (Product product : productList) {
                    String[] data = {
                            ...
                            String.valueOf(product.getPaid()),
                ...
                HttpHeaders headersCSV = new HttpHeaders();
                headersCSV.setContentType(MediaType.APPLICATION_JSON);
                ...
                // Handle the exception appropriately, possibly return an error response
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                        .body("Error occurred while generating CSV file.");
            }
        }
    }
